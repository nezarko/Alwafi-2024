...
const Header = ({ handleDrawerOpen, layout = 'landing', ...others }: Props) => {
  ...
  if (ispValue !== null && parseInt(ispValue) === 1) {
    url = 'https://themeforest.net/item/able-pro-react-mui-admin-dashboard-template/50170229?isp=1';
  } else {
    url = 'https://themeforest.net/item/able-pro-responsive-bootstrap-4-admin-template/19300403 ';
  }
